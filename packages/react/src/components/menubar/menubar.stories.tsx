...
import { BsBug, BsFacebook, BsPuzzle, BsSave, BsSave2 } from "react-icons/bs";
            ...
            <Menubar colorScheme={colorScheme}>
              <Menubar.Menu>
                ...
                <Menubar.Content>
                  ...
                  <Menubar.Item leftIcon={<FiFolder />}>
                    New Folder
                  </Menubar.Item>
                  ...
                  <Menubar.Sub>
                    ...
                    <Menubar.SubContent>
                      ...
                      <Menubar.Item leftIcon={<GearIcon />}>
                        Settings
                      </Menubar.Item>
                      <Menubar.Item leftIcon={<BsPuzzle />}>
                        Extension
                      </Menubar.Item>
                    </Menubar.SubContent>
                  </Menubar.Sub>
              ...
              <Menubar.Menu>
                ...
                <Menubar.Content>
                  ...
                  <Menubar.Item leftIcon={<ArrowRightIcon />}>
                    Redo
                  </Menubar.Item>
                  ...
                  <Menubar.Item leftIcon={<ClipboardCopyIcon />}>
                    Copy
                  </Menubar.Item>
                  <Menubar.Item leftIcon={<ClipboardIcon />}>
                    Paste
                  </Menubar.Item>
              ...
              <Menubar.Menu>
                ...
                <Menubar.Content>
                  ...
                  <Menubar.Item>Open View...</Menubar.Item>
                  ...
                  <Menubar.Sub>
                    ...
                    <Menubar.SubContent>
                      ...
                      <Menubar.Item leftIcon={<ZoomInIcon />}>
                        Zoom In
                      </Menubar.Item>
