    ...
    <div className="flex">
      <div className="lg:w-1/2 w-full">
        ...
        <p className="mt-2 text-lg rounded">
          ...
          <br />
          For example, you need <a>@radix-ui/colors</a> in every component with
          a color sceme.
        </p>
        ...
        <p className="mt-2 text-lg rounded">
          This is a utility function that I use in most of my components. You
          can copy it and paste it in any place you want (in the project, obv!)
        </p>
